...
abstract class Skin_Base extends Elementor_Skin_Base {
	...
	function render_custom_content( $settings, $helper ) {
		...
		<?php foreach ( $settings['timeline_items'] as $index => $item ) : ?>
			...
			?>
            <div id="<?php echo $item['_id'] ?>"
                 class="eae-timeline-item elementor-repeater-item-<?php echo $item['_id'] ?> custom-image-style-<?php echo $item['tl_custom_image_style'] ?> image-position-<?php echo $image_align; ?>">
